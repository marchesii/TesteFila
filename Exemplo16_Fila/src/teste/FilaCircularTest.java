...
public class FilaCircularTest extends TestCase {
	FilaCircular fila1 = new FilaCircular();
	FilaCircular fila2 = new FilaCircular(2);
	FilaCircular fila3 = new FilaCircular(5);
	...
	public void testEnqueue() {
		...
		// assertEquals(resultadoEsperadoErrado, fila1.enqueue("Elemento vermelho"));
		
		assertEquals(resultadoEsperadoSim, fila1.enqueue(12345));
		// assertEquals(resultadoEsperadoErrado, fila1.enqueue(12345));
		
		assertEquals(resultadoEsperadoSim, fila1.enqueue(ops));
		// assertEquals(resultadoEsperadoErrado, fila1.enqueue(ops));
		...
		// assertEquals(resultadoEsperadoCerto, fila1.enqueue(ops));
	...
	public void testAParte() {
		FilaEstatica fila4 = new FilaEstatica(3);
		fila4.enqueue("elemento");
		fila4.enqueue("elemento");
		fila4.enqueue("elemento");
		fila4.dequeue();
		fila4.dequeue();
		fila4.dequeue();
		fila4.enqueue("Elemento");
		fila4.enqueue("Arroba");
		assertEquals(resultadoEsperadoNao, fila4.isEmpty());
